...
namespace Tyuiu.ChazovaSR.Sprint1.Task4.V13
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("*данные, вычисляет результат по формуле cos(x/y)/(3e^x+y) *");
            ...
            Console.WriteLine("***********************************************************");
            Console.WriteLine("cos ( x / y ) / ( 3 e ^ x + y ) = " + ds.Calculate(x, y));
